...
const SchablonPage: React.FC = () => {
  ...
  const GRID_HEIGHT = 439;

  const imageLeft = (507 - GRID_WIDTH) / 2;
  const imageTop = (560 - GRID_HEIGHT) / 2;
  ...
  return (
    <div ref={containerRef} style={{ position: 'relative', height: '100%', backgroundColor: '#FAFBFF' }}>
      ...
      {/* Правая колонка — кнопки и таблица */}
      <div
        style={{
          position: 'absolute',
          top: '106px',
      ...
      >
        ...
        >
          {/* Слева 2 кнопки: Schablon1, Schablon3 */}
          <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
            <button
              onClick={() => handleButtonClick(0)}
              style={getRoundButtonStyle(activeButtons.includes(0))}
            >
              <img
                src={Schablon1}
                alt=""
                style={{
                  width: '24px',
                  height: '24px',
                  filter: activeButtons.includes(0) ? 'brightness(0) invert(1)' : 'none',
                  transition: 'filter 0.3s ease',
                }}
              />
            </button>
            <button
              ...
              style={getRoundButtonStyle(activeButtons.includes(2))}
            >
              <img
                src={Schablon3}
                alt=""
                style={{
                  width: '24px',
                  height: '24px',
                  filter: activeButtons.includes(2) ? 'brightness(0) invert(1)' : 'none',
                  transition: 'filter 0.3s ease',
                }}
              />
            </button>
          ...
          {/* Центр: длинная кнопка 411×54 + J-кнопка (только если открыто через станцию) */}
          <div style={{ display: 'flex', alignItems: 'center', gap: '20px', marginLeft: '145px' }}>
            ...
            {showJButton && (
              <button
                ...
                style={getRoundButtonStyle(isActive)}
              >
                <img
                  src={isActive ? IconJ2 : IconJ1}
                  alt=""
                  style={{
                    width: '24px',
                    height: '14px',
          ...
          {/* Справа 2 кнопки: Schablon4, Schablon5 */}
          <div style={{ display: 'flex', alignItems: 'center', gap: '20px', marginLeft: 'auto' }}>
            <button
              onClick={() => handleButtonClick(3)}
              style={getRoundButtonStyle(activeButtons.includes(3))}
            >
              <img
                src={Schablon4}
                alt=""
                style={{
                  width: '24px',
                  height: '24px',
                  filter: activeButtons.includes(3) ? 'brightness(0) invert(1)' : 'none',
                  transition: 'filter 0.3s ease',
                }}
              />
            </button>
            <button
              ...
              style={getRoundButtonStyle(activeButtons.includes(4))}
            >
              <img
                src={Schablon5}
                alt=""
                style={{
                  width: '24px',
                  height: '24px',
                  filter: activeButtons.includes(4) ? 'brightness(0) invert(1)' : 'none',
                  transition: 'filter 0.3s ease',
                }}
              />
            </button>
