...
const EnterprisesPage = () => {
  ...
  const handleCreateSubmit = async () => {
    ...
    setIsSaving(true);
    try {
      await AxiosService.post(ConstantInfo.restApiEnterprises, { name: formName.trim() });
      await fetchData();
  ...
  const handleEditSubmit = async () => {
    ...
    setIsSaving(true);
    try {
      await AxiosService.patch(`${ConstantInfo.restApiEnterprises}/${editItem.id}`, { name: formName.trim() });
      await fetchData();
