...
const SuppliersTab: React.FC<CommonProps> = () => {
  const scrollContainerRef = useRef<HTMLDivElement>(null);
  const [hasScroll, setHasScroll] = useState(false);

  const [folders] = useState([
    {
      id: 1, name: 'Основные поставщики', isOpen: false,
      items: [
        { id: 1, name: 'ООО "ПромСнаб"', status: 'Активен', date: '2026-05-14 12:00' },
        { id: 2, name: 'АО "ТехКомплект"', status: 'Активен', date: '2026-05-10 15:30' },
      ],
    },
    {
      id: 2, name: 'Резервные поставщики', isOpen: false,
      items: [
        { id: 3, name: 'ИП Иванов А.А.', status: 'Неактивен', date: '2025-12-01 09:00' },
      ],
    },
  ]);
