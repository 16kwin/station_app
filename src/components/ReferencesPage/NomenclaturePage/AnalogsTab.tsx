...
const AnalogsTab: React.FC<CommonProps> = () => {
  const scrollContainerRef = useRef<HTMLDivElement>(null);
  const [hasScroll, setHasScroll] = useState(false);

  const [folders] = useState([
    {
      id: 1, name: 'Прямые аналоги', isOpen: false,
      items: [
        { id: 1, name: 'Сверло 10мм (аналог)', status: 'Активен', date: '2026-05-14 12:00' },
        { id: 2, name: 'Фреза 20мм (аналог)', status: 'Активен', date: '2026-05-10 15:30' },
      ],
    },
    {
      id: 2, name: 'Косвенные аналоги', isOpen: false,
      items: [
        { id: 3, name: 'Резец токарный (аналог)', status: 'Неактивен', date: '2025-12-01 09:00' },
      ],
    },
  ]);
