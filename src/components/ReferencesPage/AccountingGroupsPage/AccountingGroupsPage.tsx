// components/ReferencesPage/AccountingGroupsPage/AccountingGroupsPage.tsx
...
const AccountingGroupsPage = () => {
  ...
  useEffect(() => {
    setData([
      { uid: '1', name: 'Основные средства', description: 'ОС' },
      { uid: '2', name: 'Материалы', description: 'Мат' },
      { uid: '3', name: 'Инструменты', description: 'Инс' },
      { uid: '4', name: 'Запчасти', description: 'З/ч' },
      { uid: '5', name: 'Расходные материалы', description: 'Расх' },
    ]);
    setIsLoading(false);
  }, []);
  ...
  return (
    <div style={{ position: 'relative', height: '100%', backgroundColor: '#FAFBFC' }}>
      <div style={{ paddingTop: 35, paddingLeft: 60 }}>
        <h1 style={{ fontFamily: 'Roboto, sans-serif', fontSize: 30, fontWeight: 'bold', color: '#2D4059', margin: 0 }}>Справочник: Группы учета</h1>
      </div>
