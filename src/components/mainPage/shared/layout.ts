...
export const COLORS = {
  ...
  /* ---- Панели контролера, начальника цеха, службы закупа и аудитора ---- */
  /** Брак, «Не прошли КК», часть столбика выше среднего, дорогие поставщики графа закупок */
  rose: '#FF5C77',
  roseDark: '#E8475F',
  /** «Выпуск» и «Ожидают КК» у контролера */
  aqua: '#17DECD',
  aquaDark: '#10BDB0',
  /** «План расхода ТМЦ» и «Выдано ТМЦ» у начальника цеха, «Инциденты» у аудитора */
  salmon: '#FE967E',
  salmonDark: '#F07A60',
  /** «Выпуск» и лента «Выпуск продукции» у начальника цеха */
  peach: '#FEA67F',
  peachDark: '#F48A5E',
  /** Минимальный остаток в карточке «Крит./Мин. остатки» службы закупа */
  apricot: '#FEBD9F',
  /** Линия среднего уровня брака у контролера */
  amberLine: '#FFAD4F',
  /** Якорный поставщик на графе закупок */
  anchorGreen: '#1DE24D',
} as const;
